...
_ugvs = ["I_G_Offroad_01_armed_F", "I_G_Offroad_01_AT_F", "I_MRAP_03_F", "I_MRAP_03_gmg_F", "I_UGV_01_rcws_F", "I_LT_01_AT_F", "I_LT_01_scout_F", "I_LT_01_AA_F", "I_LT_01_cannon_F" ];
_tanks = ["I_APC_tracked_03_cannon_F", "I_MBT_03_cannon_F", "I_APC_Wheeled_03_cannon_F"];
...
_vehicles = _cars + _trucks + _karts + _ugvs + _tanks + _helis;
...
_carpos = _car_safepos + [_zcarpos+0.5];
