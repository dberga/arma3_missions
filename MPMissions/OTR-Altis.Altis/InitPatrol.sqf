// initPatrol.sqf - Initialize logic entity as a site with simple capture detection
params ["_site"];

// Only run on server
if (!isServer) exitWith {};

private _locations = [];          //"Name", "NameMarine","NameCityCapital","NameCity","NameVillage","NameLocal"
private _allLocations = nearestLocations [[worldSize/2,worldSize/2,0], ["Mount","Hill","ViewPoint","RockArea","BorderCrossing","VegetationBroadleaf","VegetationFir","VegetationPalm","VegetationVineyard"], worldSize/2];         
...
private _pos = [_location select 1, 5, 250, 5, 0, 0.25, 0] call BIS_fnc_findSafePos;     
_site setPos _pos;        
