...
//_markerName = "Marker_MyLootSpawnTrigger_"+str (floor random (1000));
//createMarker [_markerName, _buildingPosition];
//_markerName setMarkerType "hd_dot";
//_markerName setMarkerColor "ColorRed";
//_markerName setMarkerText "loot";
//_markerName setMarkerAlpha 1; 
_weaponR = floor random(43);
...
case 34: {_myweapon = "srifle_LRR_SOS_F";};
...
case 38: {_myweapon = "launch_NLAW_F";};
case 39: {_myweapon = "launch_RPG32_F";};
case 40: {_myweapon = "launch_Titan_F";};
case 41: {_myweapon = "launch_Titan_short_F";};
case 42: {_myweapon = "launch_MRAWS_sand_F";};
default {};
};
if(_weaponR < 38) then {
_ammobox addWeaponCargoGlobal [_myweapon, 1];
...
_ammobox addMagazineCargoGlobal [_mymagazine, _randmagazine];
};
};
...
if(_pistolR < 9) then {
_ammobox addWeaponCargoGlobal [_mypistol, 1];
...
_ammobox addBackPackCargoGlobal [_mybackpack,1];
};
...
if (_itemR < 27) then {
_ammobox addItemCargoGlobal [_myitem,1];
};
...
case 31: {_myitem = "Medikit";};
case 31: {_myitem = "RPG32_F";};
case 32: {_myitem = "RPG32_HE_F";};
case 33: {_myitem = "Titan_AA";};
case 34: {_myitem = "Titan_AT";};
case 35: {_myitem = "Titan_AP";};
case 36: {_myitem = "NLAW_F";};
case 37: {_myitem = "DemoCharge_Remote_Mag";};
case 38: {_myitem = "MRAWS_HEAT_F";};
case 39: {_myitem = "MRAWS_HE_F";};
case 40: {_myitem = "MRAWS_HEAT55_F";};
case 41: {_myitem = "APERSBoundingMine_Range_Mag";};
case 42: {_myitem = "SLAMDirectionalMine_Wire_Mag";};
case 43: {_myitem = "APERSTripMine_Wire_Mag";};
case 44: {_myitem = "ClaymoreDirectionalMine_Remote_Mag";};
case 45: {_myitem = "SatchelCharge_Remote_Mag";};
case 46: {_myitem = "IEDUrbanBig_Remote_Mag";};
default {};
};
if (_itemR < 31) then {
_ammobox addItemCargoGlobal [_myitem,1];
};
_rAmmo = floor (random (11));
switch(_rAmmo) do {
...
case 10: {_myitem = "ToolKit";};
};
if (_rAmmo < 10) then {
_ammobox addItemCargoGlobal [_myitem,1];
};
if ((_itemR > 46) && (_weaponR > 42) && (_backpackR > 9)) then {
